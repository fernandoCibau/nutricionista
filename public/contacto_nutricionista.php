<?php
    ...
    try {
        ...
        $provincias = []; // Asegurarse de que la variable exista
        $localidades = []; // Asegurarse de que la variable exista
...
<body>
    ...
    <main class="container my-5">
        <div class="text-center mb-5">
            <h1 class="display-5 fw-bold">Ofrecenos tus servicios</h1>
            <p class="lead">Completa el formulario y da el primer paso para trabajar con nosotros. Nos contactaremos para coordinar una entrevista.</p>
        </div>
            ...
            <div class="col-md-6">
                <form action="enviar_contacto.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="localidad_id" id="localidad" class="form-select" required disabled>
                            <option value="">Seleccione una provincia primero</option>
                        </select>
                    </div>
                    <input type="hidden" name="asunto" value="Solicitud trabajo como Nutricionista">
                    <div class="mb-3"><label for="mensaje" class="form-label">Cuéntanos sobre tu experiencia</label><textarea class="form-control" id="mensaje" name="mensaje" rows="5" required></textarea></div>
    ...
    <script>
        const todasLasLocalidades = <?php echo json_encode($localidades); ?>;
        ...
        document.getElementById('provincia').addEventListener('change', function() {
            ...
            if (provinciaId) {
                // Filtrar localidades para la provincia seleccionada
                const localidadesFiltradas = todasLasLocalidades.filter(localidad => localidad.ID_PROV == provinciaId);
